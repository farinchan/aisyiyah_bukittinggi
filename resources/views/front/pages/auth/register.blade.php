                ...
                <div class="col-md-12">
                    <div class="login-form">
                        ...
                        <p class="text-center mb-4" style="padding: 0 20px;">
                            ...
                            bertanda bintang (*). <br> Jika anda sudah memiliki akun, silahkan login <a href="{{ route('login') }}">disini</a>.
                        </p>
                        <form action="{{ route('register.process') }}" method="POST" style="margin-top: 40px;"
                            ...
                            <div class="form-group row">
                                <label for="place_of_birth" class="col-sm-3 col-form-label">Tempat, Tanggal Lahir *</label>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="keanggotaan" name="keanggotaan" required>
                                        ...
                                        <option value="Kader Aisyiyah"
                                            {{ old('keanggotaan') == 'Kader Aisyiyah' ? 'selected' : '' }}>Kader Aisyiyah
                                        </option>
                                        <option value="Warga Aisyiyah"
                                            {{ old('keanggotaan') == 'Warga Aisyiyah' ? 'selected' : '' }}>Warga Aisyiyah
                                        </option>
                                        <option value="Simpatisan Aisyiyah"
                                            {{ old('keanggotaan') == 'Simpatisan Aisyiyah' ? 'selected' : '' }}>Simpatisan
                                            Aisyiyah</option>
                                    </select>
                                    @error('keanggotaan')
                                        <small class="text-danger">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group-icon">
                                        <select id="job" class="select2 form-select" name="job[]"
                                            ...
                                            <option value="Kondektur"@if (in_array('Kondektur', $job)) selected @endif>
                                                Kondektur</option>
                                            <option value="Pilot"@if (in_array('Pilot', $job)) selected @endif>
                                                Pilot</option>
                                            <option value="Masinis"@if (in_array('Masinis', $job)) selected @endif>
                                                Masinis</option>
                                            <option value="Wartawan"@if (in_array('Wartawan', $job)) selected @endif>
                                                Wartawan</option>
                                            ...
                                            <option value="Ahli Gizi"@if (in_array('Ahli Gizi', $job)) selected @endif>
                                                Ahli Gizi</option>
                                            <option value="Pustakawan"@if (in_array('Pustakawan', $job)) selected @endif>
                                                Pustakawan</option>
                                            <option value="Hakim"@if (in_array('Hakim', $job)) selected @endif>
                                                Hakim</option>
                                            <option value="Notaris"@if (in_array('Notaris', $job)) selected @endif>
                                                Notaris</option>
                                            <option value="Teller Bank"@if (in_array('Teller Bank', $job)) selected @endif>
                                                Teller Bank</option>
                                            <option value="Koki"@if (in_array('Koki', $job)) selected @endif>
                                                Koki</option>
                                            <option value="Artis"@if (in_array('Artis', $job)) selected @endif>
                                                Artis</option>
                                            <option value="Penerjemah"@if (in_array('Penerjemah', $job)) selected @endif>
                                                Penerjemah</option>
                                            ...
                                            <option value="Akuntan"@if (in_array('Akuntan', $job)) selected @endif>
                                                Akuntan</option>
                                            <option value="Pengacara"@if (in_array('Pengacara', $job)) selected @endif>
                                                Pengacara</option>
                                            ...
                                            <option value="Wiraswasta"@if (in_array('Wiraswasta', $job)) selected @endif>
                                                Wiraswasta</option>
                            ...
                            <div class="form-group row" id="kepakaran">
                                ...
                                <div class="col-sm-9">
                                    <select name="kepakaran" id="kepakaran"
                                        ...
                                        <option value="Tafsir" {{ old('kepakaran') == 'Tafsir' ? 'selected' : '' }}>Tafsir</option>
                                        <option value="Hadist" {{ old('kepakaran') == 'Hadist' ? 'selected' : '' }}>Hadist</option>
                                        <option value="Fiqih" {{ old('kepakaran') == 'Fiqih' ? 'selected' : '' }}>Fiqih</option>
                                        <option value="Aqidah" {{ old('kepakaran') == 'Aqidah' ? 'selected' : '' }}>Aqidah</option>
                                        <option value="Tarikh" {{ old('kepakaran') == 'Tarikh' ? 'selected' : '' }}>Tarikh</option>
                                    </select>
                                    @error('kepakaran')
                                        <small class="text-danger">
                                            {{ $message }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="ktam" name="ktam" required>
                                        <option value="Ada" {{ old('ktam') == 'Ada' ? 'selected' : '' }}>Ada</option>
                                        <option value="Tidak Ada" {{ old('ktam') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                    </select>
                                    @error('ktam')
                                        <small class="text-danger">
                                            {{ $message }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nbm" name="nbm" placeholder="Masukkan NBM" value="{{ old('nbm') }}">
                                    @error('nbm')
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" id="email" name="email"
                                        ...
                                        <small class="text-muted">Pastikan email yang anda masukkan adalah email yang aktif, karena kami akan mengirimkan informasi ke email tersebut.</small>
                                    @error('email')
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="password" name="password"
                                        ...
                                        <small class="text-muted">Minimal 8 karakter, kombinasi huruf besar, huruf kecil, angka dan simbol</small>
                                    @error('password')
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
